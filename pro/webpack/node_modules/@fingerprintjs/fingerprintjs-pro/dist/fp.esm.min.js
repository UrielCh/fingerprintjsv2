...
function asyncUnknownMdtJ(errorFilter, arg2, agr3, arg4, arg5) {
    return __awaiter(this, undefined, undefined, function() {
        var e, s, u;
        return __generator(this, function(t) {
            switch (t.label) {
                case 0:
                    (s = function s(e) {
                        ...
                        errorFilter && asyncWwwwUnknown(function() {
                ...
                case 1:
                    return t.trys.push([1, 3, , 4]), [4, arg5()];

                case 2:
                    return e = t.sent(), [3, 4];

                case 3:
                    throw u = t.sent(), s(arg4, u), u;
        ...
        constructor(e) {
            ...
            this.onReportReady = e, this.isStopped = false, this.pageStartTimestamp = function() {
                ...
                if (!self.isStopped) {
                    ...
                    switch (0 !== e.e && 3 !== e.e || (n.documentReadyState = document.readyState, n.isPageVisible = getIsPageVisible(), n.isFullscreen = getIsFullscreen(), n.network = getNetworkStat()), self.storeAgentEvent(n), e.e) {
                        case 2:
...
function Z(eventObj) {
    ...
    switch (eventObj.type) {
        ...
        case "pageTransition":
            return __assign(__assign({}, t), {
                body: {
                    message: eventObj.isShown ? "Page is restored from browser history" : "Page is about to go to browser history"
                }
            });
        ...
        case "networkChange":
            return __assign(__assign({}, t), {
                body: __assign(__assign({}, eventObj.network), {
...
function aaaeee(endpoint, timeout, iiaiiia) {
    return __awaiter(this, undefined, undefined, function() {
        return __generator(this, function(o) {
            return [2, asyncUnknownMdtJ(iiaiiia, function() {
                return {
                    e: 6,
                    endpoint: endpoint,
                    timeout: timeout
    ...
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                ...
                case 4:
                    return r ? [2, r < getMaxMem()] : [2, false];
            }
        });
    });
}
        ...
        for (;;) {
            ...
            switch (l[0]) {
                ...
                case "[":
                    ...
                    addAttribut(d[1], null !== (n = null !== (t = d[4]) && undefined !== t ? t : d[5]) && undefined !== n ? n : "");
                    break;
    ...
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                ...
                case 1:
                    return document.body ? [3, 3] : [4, delay(100)];
...
componentsSources[9] = function(n) {
...
componentsSources[13] = function(n) {
    ...
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                case 0:
                    return isWebKit() || (s = window, u = isChromium(), c = isGecko(), (u || c) && countTruthy(["onorientationchange" in s, "orientation" in s, u && "SharedWorker" in s, c && /android/i.test(navigator.appVersion)]) >= 2) ? [4, Beddddddd((i = []).concat.apply(i, allAdList.map(function(e) {
                        return adBlockTestList[e];
                    })))] : (Ue(r, undefined), [2, undefined]);

                case 1:
                    return e = t.sent(), Ue(r, e), (n = allAdList.filter(function(t) {
...
componentsSources[18] = function() {
    return getMatchMediaPrefersContrast("no-preference") ? 0 : getMatchMediaPrefersContrast("high") || getMatchMediaPrefersContrast("more") ? 1 : getMatchMediaPrefersContrast("low") || getMatchMediaPrefersContrast("less") ? -1 : getMatchMediaPrefersContrast("forced") ? 10 : undefined;
};
componentsSources[19] = function() {
    return !!getMatchMediaPrefersReduceMotion("reduce") || !getMatchMediaPrefersReduceMotion("no-preference") && undefined;
};
            ...
            switch (t.label) {
                case 0:
                    return e = {}, [4, Tt(function(t, n) {
                        for (var r = {}, i = 0, o = Object.keys(fontData); i < o.length; i++) {
                            var a = o[i],
                                s = fontData[a],
                                u = s[0],
                                c = undefined === u ? {} : u,
                        ...
                        for (var g = 0, b = Object.keys(fontData); g < b.length; g++) {
...
function Mt(e, t, paramDays) {
    var hostname = location.hostname;
    (Dt(hostname, function(t) {
        ! function(e, t) {
            Ot(e, "", -1, t);
        }(e, t);
    }), paramDays < 0) || Dt(hostname, function(r) {
        Ot(e, t, paramDays, r);
        return getKeyInCookie(e) !== t;
    }) && Ot(e, t, paramDays);
}

function Dt(hostname, t) {
    var len = hostname.length;
    do {
        if (len = len > 0 ? hostname.lastIndexOf(".", len - 1) : -1, false === t(hostname.slice(len + 1))) return false;
    } while (len >= 0);
    return true;
}
...
function qqttt(agentId, pppMProvider, callGetComponentsFnc, options) {
    ...
    var m = function m(tag, linkedId, o, a, extendedResult, ipResolution, p) {
            return __awaiter(that, undefined, undefined, function() {
                ...
                return __generator(this, function(t) {
                    switch (t.label) {
                        case 0:
                            return [4, Promise.all([misteryCall(theRegion, tlsEndpoint, a, !!o, p), w(p)])];
        ...
        misteryCall = function misteryCall(theRegion, tlsEndpoint, ii3, oo4, oo5) {
            return __awaiter(that, undefined, undefined, function() {
                return __generator(this, function(e) {
                    return oo4 ? [2, undefined] : [2, aaaeee(function(region, tlsEndpoint) {
                        return tlsEndpoint || endpoints[region];
                    }(theRegion, tlsEndpoint), ii3, oo5).then(function(e) {
                        return {
                            tls: e
                        };
                    }, function(e) {
            ...
            return asyncUnknownMdtJ(r, function() {
                ...
                return __awaiter(that, undefined, undefined, function() {
                    ...
                    return __generator(this, function(t) {
                        switch (t.label) {
                            case 0:
                                return [4, pppMProvider.get()];

                            case 1:
                                return e = t.sent(), [4, callGetComponentsFnc({
    ...
    return {
        get: function get(e) {
            ...
            }(makeMulticastDebugger([debug, e.debug && makeConsoleDebugger()]), agentId, randomString(8)) : undefined;
        ...
        return __awaiter(r, undefined, undefined, function() {
            ...
            return __generator(this, function(t) {
                switch (t.label) {
                    ...
                    case 1:
                        eProvider = t.sent();
                        return [2, qqttt(agentId, eProvider, callGetComponents, option)];
                }
            });
        });
    });
