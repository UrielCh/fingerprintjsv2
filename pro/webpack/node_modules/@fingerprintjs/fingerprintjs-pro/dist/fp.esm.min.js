...
function VFunGlobal(e, t, r, i, filterSucess) {
    if (undefined !== t) return undefined !== r ? Object.assign(Object.assign({}, null == filterSucess ? undefined : filterSucess(r)), {
...
function Z(eventObj) {
    ...
    var event = eventObj.event,
        formatData = function formatData(_data, level) {
            ...
            for (var a = Object.assign(Object.assign({}, t), {
                    level: level,
                    body: Object.assign({
...
function encodeToBeacon(result) {
    ...
    return function(e, t) {
        for (var r = {}, i = 0, o = Object.keys(e); i < o.length; i++) {
            var a = o[i];
            !e[a].error && t[a] ? r[a] = Object.assign(Object.assign({}, e[a]), {
                error: undefined,
                value: t[a](e[a].value)
            }) : r[a] = e[a];
        }
...
function bundleData(processedData) {
    ...
    bundle.s47 = fe(components[28], function(e) {
        return {
            s: e ? 0 : -1,
            v: e ? Object.assign(Object.assign({}, e), {
...
function ke(i, o) {
    ...
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                case 0:
                    return e = bundleData(Object.assign({
...
componentsSources[3] = function() {
    var makeCanvasContext = function() {
            ...
            return canvas.width = 240, canvas.height = 140, canvas.style.display = "inline", [canvas, canvas.getContext("2d")];
        }(),
    ...
    if (! function(e, t) {
        ...
        }(canvas, context)) return {
        winding: false,
        data: ""
    };
    context.rect(0, 0, 10, 10), context.rect(2, 2, 6, 6);
    var r = !context.isPointInPath(5, 5, "evenodd");
    context.textBaseline = "alphabetic", context.fillStyle = "#f60", context.fillRect(125, 1, 62, 20), context.fillStyle = "#069", context.font = "11pt no-real-font-123";
    var i = "Cwm fjordbank 😃 gly";
    return context.fillText(i, 2, 15), context.fillStyle = "rgba(102, 204, 0, 0.2)", context.font = "18pt Arial", context.fillText(i, 4, 45), context.globalCompositeOperation = "multiply", context.fillStyle = "rgb(255,0,255)", context.beginPath(), context.arc(50, 50, 50, 0, 2 * Math.PI, true), context.closePath(), context.fill(), context.fillStyle = "rgb(0,255,255)", context.beginPath(), context.arc(100, 50, 50, 0, 2 * Math.PI, true), context.closePath(), context.fill(), context.fillStyle = "rgb(255,255,0)", context.beginPath(), context.arc(75, 100, 50, 0, 2 * Math.PI, true), context.closePath(), context.fill(), context.fillStyle = "rgb(255,0,255)", context.arc(75, 75, 75, 0, 2 * Math.PI, true), context.arc(75, 75, 25, 0, 2 * Math.PI, true), context.fill("evenodd"), {
        winding: r,
...
componentsSources[8] = function() {
    ...
    return "webdriver" in win || "_Selenium_IDE_Recorder" in win || "callSelenium" in win || "_selenium" in win || "__webdriver_script_fn" in doc || "__driver_evaluate" in doc || "__webdriver_evaluate" in doc || "__selenium_evaluate" in doc || "__fxdriver_evaluate" in doc || "__driver_unwrapped" in doc || "__webdriver_unwrapped" in doc || "__selenium_unwrapped" in doc || "__fxdriver_unwrapped" in doc || "__webdriver_script_func" in doc || null !== elm.getAttribute("selenium") || null !== elm.getAttribute("webdriver") || null !== elm.getAttribute("driver");
};
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                case 0:
                    ...
                    }(storageKey = storageKeyPrefix + "_i")) ? [2 /*return*/ , n] : [4 /*yield*/ , Le()];

                case 1:
                    return toStoreValue = t.sent(),
                        function(e, t) {
                            try {
                                localStorage.setItem(e, t ? "1" : "0");
                            } catch (n) {}
                        }(storageKey, toStoreValue), [2 /*return*/ , toStoreValue];
            }
        });
    });
};
...
componentsSources[10] = function() {
    ...
    try {
        ...
        return -1 !== foundIndex && 1321 !== thearray.slice(foundIndex + 5, c).reduce(function(e, t) {
            return e + t;
        }, 0);
    } catch (l) {
        return false;
    ...
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                ...
                case 1:
                    return t.trys.push([1, , 3, 4]), [4 /*yield*/ , new Promise(function(eFncParam, tParram) {
                        var n,
                            o = [],
                        ...
                        r.onicecandidate = function(e) {
                            ...
                            }, r.onicecandidateerror = tParram, null === (n = r.createDataChannel) || undefined === n || n.call(r, "test"),
                            function(e, t) {
                                try {
...
function mygetShaderPrecisionFormat(webgl, shaderType, precisionType) {
    ...
    if (webGLShaderPrecisionFormat)
        return [webGLShaderPrecisionFormat.rangeMin, webGLShaderPrecisionFormat.rangeMax, webGLShaderPrecisionFormat.precision];
    return [];
}

const webGLVarsText = ["MAX_TEXTURE_MAX_ANISOTROPY_EXT", "FRAGMENT_SHADER_DERIVATIVE_HINT_OES", "MAX_COLOR_ATTACHMENTS_WEBGL", "MAX_DRAW_BUFFERS_WEBGL", "DRAW_BUFFER0_WEBGL", "DRAW_BUFFER1_WEBGL", "VERTEX_ARRAY_BINDING_OES", "TIMESTAMP_EXT", "GPU_DISJOINT_EXT", "MAX_VIEWS_OVR"];
...
componentsSources[28] = function() {
    ...
    if (webgl) {
        var oooo = Object.assign(Object.assign({}, function(webgl) {
                    ...
                    if (extention) {
                        ...
                        for (let itr = 0 ; itr < keyList.length; itr++) {
                            ...
                            if (webGLVarsText.indexOf(x) > 0)
                                ...
                                extensionParametersList.push(x + "=" + value);
                        }}
                }
            }
        ...
        (function(webgl) {
            ...
            if (program) {
                iiiiii(0, "attribute vec2 p;uniform float t;void main(){float s=sin(t);float c=cos(t);gl_Position=vec4(p*mat2(c,s,-s,c),1,1);}");
            ...
            return __awaiter(that, undefined, undefined, function() {
                ...
                return __generator(this, function(t) {
                    switch (t.label) {
                        ...
                        case 1:
                            return e = t.sent(), s = e[0], components = e[1], [4 /*yield*/ , ke(Object.assign(Object.assign({}, s), {
                                token: token,
    ...
    return {
        get: function get(e) {
            ...
            var errorFilter = debug || e.debug ? function(e, agentId, getCallId) {
                return function(i) {
                    return e(Object.assign(Object.assign({}, i), {
                        agentId: agentId,
                        getCallId: getCallId
                    }));
                };
