 ...
 */
import { __awaiter, __generator, __assign, __rest, __spreadArrays } from "tslib";
import {
    isChromium,
    isGecko,
            ...
            o = function(timeout2, t, n) {
                var waitingTimeout,
                    ...
                    theStart = function theStart() {
                        startedOnce || undefined !== waitingTimeout || (startTime = Date.now(), waitingTimeout = setTimeout(function() {
                            startedOnce = true, n();
                        }, timeout3));
                    };
                ...
                return t && theStart(), {
                    start: theStart,
                    stop: function stop() {
                        startedOnce || undefined === waitingTimeout || (clearTimeout(waitingTimeout), waitingTimeout = undefined, timeout3 -= Date.now() - startTime);
                    }
                };
...
function asyncWwwwUnknown(nnFnc, rrrrrr) {
...
function makeMulticastDebugger(debugsOutput) {
    return function() {
        ...
        var rrrFnc = function rrrFnc(inFncEE) {
            if (inFncEE) asyncWwwwUnknown(function() {
                return inFncEE.apply(undefined, t);
            });
        };
        for (var i = 0; i < debugsOutput.length; i++) {
            rrrFnc(debugsOutput[i]);
        }
    };
}

function unBoxError(error, keepStack) {
    if (undefined === keepStack)
        keepStack = false;
    let stack;
    if (keepStack)
        stack = error.stack
    ...
    return function(theError) {
        switch (theError.e) {
            ...
            case 18:
                ...
                console.log(formatError(debugPrefix, a) + "\n" + function(e, t) {
...
function formatError(e, t) {
    ...
    Object.keys(i).length && (o += "\n```\n" + function(e) {
        return JSON.stringify(e, function(e, error) {
...
function doHttpPost(postCall) {
    ...
    var xmlHttpReq = new XMLHttpRequest();
    xmlHttpReq.open("POST", url, ! function() {
        var e,
...
function mainNFnc(e, ppp_min) {
    ...
    return __generator(this, function(t) {
        switch (t.label) {
            ...
            case 2:
                return [4, [r = Math.min(ppp_min, e + Math.random() * (3 * r - e)), undefined]];
...
function asyncUnknownMdtJ(n, r, i, o, a) {
    return __awaiter(this, undefined, undefined, function() {
        var e, s, u;
        return __generator(this, function(t) {
            switch (t.label) {
...
var G = function() {
    function bigClassDef(e) {
        ...
        var mediumLocalMtd = function(e, t) {
            ...
            registerConnectionStatusChange = function(onCnxChange) {
                ...
                return (null == navigatorConnection ? undefined : navigatorConnection.addEventListener) ? (navigatorConnection.addEventListener("change", onCnxChange), function() {
                    navigatorConnection.removeEventListener("change", onCnxChange);
                }) : (addEventListener("online", onCnxChange), addEventListener("offline", onCnxChange), function() {
    ...
    bigClassDef.prototype.handleDocumentReadyStateChange = function() {
    ...
    bigClassDef.prototype.handleVisibilityChange = function() {
        this.storeEnvironmentEvent({
            time: new Date(),
    ...
    bigClassDef.prototype.handlePageTransition = function(e) {
        this.storeEnvironmentEvent({
            time: new Date(),
            type: "pageTransition",
            isShown: e
    ...
    bigClassDef.prototype.handleFullscreenChange = function() {
        this.storeEnvironmentEvent({
            time: new Date(),
    ...
    bigClassDef.prototype.handleNetworkConnectionChange = function() {
        this.storeEnvironmentEvent({
            time: new Date(),
            type: "networkChange",
            network: J()
    ...
    bigClassDef.prototype.handlePageUnload = function() {
        this.storeEnvironmentEvent({
            time: new Date(),
            type: "pageUnload"
        });
    ...
    bigClassDef.prototype.storeAgentEvent = function(e) {
        var t = e.event,
            n = t.agentId;
    ...
    bigClassDef.prototype.storeEnvironmentEvent = function(e) {
    ...
    bigClassDef.prototype.submitReport = function(e, t) {
        var r = function(e, t) {
...
function Z(e) {
    ...
    switch (r.e) {
        ...
        case 7:
            return i({
                result: limitTextLen(r.result, 1000)
            });
            ...
            switch (t.label) {
                case 0:
                    return e = function(e) {
                        ...
                        var o;
                        return i;
                    }(i), [4, mainLFnc(function() {
                        if (!navigator.onLine || !doHttpPost({
                                url: r,
                                body: e
                            })) throw new Error();
                    }, mainNFnc(1000, 10000))];
...
function ae(n, r, i) {
    return __awaiter(this, undefined, undefined, function() {
        return __generator(this, function(o) {
            return [2, asyncUnknownMdtJ(i, function() {
                return {
                    e: 6,
                    endpoint: n,
                    timeout: r
                    ...
                    return function(n, r, i, o) {
                        return __awaiter(this, undefined, undefined, function() {
                            ...
                            return __generator(this, function(t) {
                                switch (t.label) {
                                    case 0:
                                        return t.trys.push([0, 2, , 3]), [4, asyncUnknownMdtJ(o, function() {
                                            return {
                                                e: 9,
                                                tryNumber: i,
                                                timeout: r
                    ...
                    return __generator(this, function(v) {
                        switch (v.label) {
                            case 0:
                                ...
                                }(Math.max(1, param1_number), function(e) {
                                    var n, r, i, o, a, s, u;
                                    return __generator(this, function(t) {
                                        switch (t.label) {
                                            case 0:
                                ...
                                }(mainNFnc(param2_num, param3_timeout))), u = 0, v.label = 1;

                            case 1:
                                return u < param4_max ? (c = s ? a.next(s) : a.next()).done ? [3, 4] : (l = c.value, d = l[0], f = l[1][0], [4, [d, {
                                    number: u,
...
function ke(i, o) {
    ...
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                case 0:
                    return e = bundleData(__assign({
                        extendedResult: extendedResult
                    }, u)), [4, _e(a, e, o)];

                case 1:
                    return [2, handleEndpointResponse(t.sent(), extendedResult)];
            }
        });
    });
}
    ...
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                ...
                case 1:
                    return t.trys.push([1, 3, , 4]), [4, asyncUnknownMdtJ(i, function() {
                        return {
                            e: 15,
...
function handleEndpointResponse(response, extendedResult) {
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            ...
            // have visitorId
            if (function(jsonData) {
                    return jsonData && "object" == typeof jsonData && "string" == typeof jsonData.visitorId && "n/a" !== jsonData.visitorId;
                }(data)) return logErrorLvl(data.notification), [2, processWithVisitorId(data)];

            if (function(e) {
                    return e && "object" == typeof e && "n/a" === e.visitorId;
                }(data)) {
                if (logErrorLvl(data.notification), "Not available for crawl bots" === data.reason || "Not available when User-Agent is unspecified" === data.reason) return [2, processWithoutVisitorId(data, extendedResult)];
...
var De = [
    ...
    [function() {
        ...
        return __awaiter(this, undefined, undefined, function() {
            return __generator(this, function(e) {
                return isBrowser_() ? [2, isInconito0()] : [2, isIncomito1()];
            });
        });
    }],
    [function() {
...
var At = ((allTest = {})[0] = function() {
    ...
    try {
        ...
        var foundIndex = findInArray(a, [73, 68, 65, 84, 24]);
        if (-1 === foundIndex) return false;
        var c = findInArray(a, [73, 69, 78, 68]);
        return -1 !== foundIndex && 1321 !== a.slice(foundIndex + 5, c).reduce(function(e, t) {
            return e + t;
        }, 0);
    } catch (l) {
        return false;
    ...
    return __awaiter(this, undefined, undefined, function() {
        ...
        return __generator(this, function(t) {
            switch (t.label) {
                ...
                case 1:
                    return t.trys.push([1, 3, , 4]), e.canMakePayments() ? isWebKit() && !isBrowser_() ? [2, {
                        s: 0,
                        v: 1
...
function Mt(e, t, n) {
    ...
    (Dt(r, function(t) {
        ...
        return Ot(e, t, n, r), getKeyInCookie(e) !== t;
    }) && Ot(e, t, n);
}
...
function getInLocalStorage(storageKey) {
    ...
    try {
        return null !== (n = null === (t = null === localStorage || undefined === localStorage ? undefined : localStorage.getItem) || undefined === t ? undefined : t.call(localStorage, storageKey)) && undefined !== n ? n : undefined;
    } catch (r) {}
}
...
function qt(r, i, o, a) {
    ...
    var m = function m(tag, linkedId, o, a, extendedResult, ipResolution, p) {
            return __awaiter(s, undefined, undefined, function() {
                ...
                return __generator(this, function(t) {
                    switch (t.label) {
                        ...
                        case 1:
                            return e = t.sent(), s = e[0], components = e[1], [4, ke(__assign(__assign({}, s), {
                                token: token,
        ...
        w = function w(r) {
            return asyncUnknownMdtJ(r, function() {
                return {
                    e: 12
                };
            }, function(e) {
    ...
    return {
        get: function get(e) {
            undefined === e && (e = {});
            var errorFilter = debug || e.debug ? function(e, agentId, getCallId) {
                return function(i) {
            ...
            return asyncUnknownMdtJ(errorFilter, function() {
                return {
                    e: 3,
                    options: e
                };
                ...
                return Promise.race([delayFocused(timeout5).then(function() {
                    throw new Error("Client timeout");
                }), m(tag, linkedId, disableTls, .4 * timeout5, extendedResult, ipResolution, errorFilter)]);
            });
        }
    };
}
...
function loadPro(option) {
    ...
    return asyncUnknownMdtJ(option.debug, function() {
        return {
            e: 0,
            agentId: agentId,
            version: version,
